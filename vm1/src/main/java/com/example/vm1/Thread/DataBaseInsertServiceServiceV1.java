...
@Service
@Slf4j
public class DataBaseInsertServiceServiceV1 implements DataBaseInsertService {
    ...
    public DataBaseInsertServiceServiceV1(RedisTemplate<String, String> redisTemplate,
...
//                log.info("lRange executed for {} keys, results size: {}", subKeys.size(), results.size());
        ...
        if (!totalBatchData.isEmpty()) {
            batchInsertRunner.runBatchInsert(totalBatchData, THREAD_COUNT);
